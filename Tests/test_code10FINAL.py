...
#The necessary packages have been uploaded. Do note that Pytest will classify "%matplotlib inline" as a bug. However, this allows the chart (as seen later) to appear without any bugs. It is now time to define some general functions.
